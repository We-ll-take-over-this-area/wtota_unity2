...
public class RightSideArm : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //다시 돌아오는 레이케스트 (공용)
        Debug.DrawRay(new Vector2(0, -3), Vector2.right, new Color(0, 1, 0));
        RaycastHit2D combackRay = Physics2D.Raycast(new Vector2(0, -3), Vector3.right, 1, LayerMask.GetMask("Boss arm"));
